...
describe("EaseMotion-css Smoke Tests", () => {
  ...
  it("should have forms and floating label input classes defined", () => {
    expect(css).toContain(".ease-input-group");
    expect(css).toContain(".ease-input-floating");
    expect(css).toContain(".ease-label-floating");
  });
