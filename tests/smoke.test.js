...
const modals = readFileSync(resolve(componentsDir, 'modals.css'), 'utf8');
  ...
  it('should have tabs, badges, loaders, tooltips, and modal classes defined', () => {
    ...
    expect(css).toContain('.ease-tab-input:nth-of-type(7):checked ~ .ease-tabs-content .ease-tab-panel:nth-of-type(7)');
    expect(css).toContain('.ease-tab-input:nth-of-type(8):checked ~ .ease-tabs-content .ease-tab-panel:nth-of-type(8)');
    expect(css).toContain('.ease-tabs-auto .ease-tab-input:nth-of-type(7):checked ~ .ease-tabs-nav .ease-tab-label:nth-of-type(7)');
    expect(css).toContain('.ease-tabs-auto .ease-tab-input:nth-of-type(8):checked ~ .ease-tabs-nav .ease-tab-label:nth-of-type(8)');
