...
describe("EaseMotion-css Smoke Tests", () => {
  ...
  beforeAll(() => {
    ...
    const zoomAccordion = readFileSync(
      resolve(componentsDir, "zoom-accordion.css"),
      "utf8"
    );
  ...
  it("should have zoom-accordion classes and properties defined", () => {
    expect(css).toContain(".ease-zoom-accordion");
    expect(css).toContain(".ease-accordion-item");
    expect(css).toContain(".ease-accordion-trigger");
    expect(css).toContain(".ease-accordion-track");
    expect(css).toContain(".ease-accordion-content");
    expect(css).toContain("--ease-accordion-zoom-duration");
    expect(css).toContain("--ease-accordion-zoom-easing");
    expect(css).toContain("--ease-accordion-zoom-scale-start");
  });
});
