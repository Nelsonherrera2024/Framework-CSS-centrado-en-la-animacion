...
The core objective of **Global Risk Observatory** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(350, 85%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(280, 80%, 60%)` - Secondary metrics lines.
