...
The core objective of **Robotics Fleet Command Center** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(260, 85%, 60%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(195, 90%, 50%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(345, 80%, 55%)` - Callouts and interactive states.
