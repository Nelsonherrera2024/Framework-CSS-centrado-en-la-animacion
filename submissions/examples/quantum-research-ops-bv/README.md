...
The core objective of **Quantum Research Operations Hub** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(290, 85%, 60%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(180, 90%, 50%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(50, 90%, 55%)` - Callouts and interactive states.
