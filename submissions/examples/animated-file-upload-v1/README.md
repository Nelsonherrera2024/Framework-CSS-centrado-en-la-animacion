...
3. When a user clicks _anywhere_ inside the label (or the button), the browser automatically triggers the hidden file input, opening the native file picker.
