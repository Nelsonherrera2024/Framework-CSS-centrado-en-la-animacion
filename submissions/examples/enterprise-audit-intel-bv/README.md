...
The core objective of **Enterprise Audit Intelligence Hub** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(285, 80%, 60%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(155, 80%, 45%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(20, 85%, 55%)` - Callouts and interactive states.
