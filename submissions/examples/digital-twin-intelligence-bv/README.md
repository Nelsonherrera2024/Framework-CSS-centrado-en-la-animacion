...
The core objective of **Digital Twin Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(200, 90%, 55%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(145, 80%, 45%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(275, 85%, 60%)` - Callouts and interactive states.
