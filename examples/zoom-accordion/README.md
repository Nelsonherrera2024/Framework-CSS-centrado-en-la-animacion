# CSS Zoom-In Accordion Component Sandbox
...
- `style.css` — Sandbox-specific presentation stylesheet loading core variables/utilities and the zoom-accordion component.
