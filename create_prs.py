...
for issue_id, name, folder_name in issues_data:
    ...
    if subprocess.run(["git", "show-branch", branch_name], capture_output=True).returncode != 0:
...
""")
    ...
    subprocess.run(["git", "push", "-f", "fork", branch_name], capture_output=True)
    ...
    result = subprocess.run([
        ...
        "--head", f"sahare-mayur-0071:{branch_name}",
